...
def get_articles_within_word_count(dataset_name, target_length, num_articles, tolerance=0.05):
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Get articles with specific word count range and save to JSON.")

    # Define the arguments
    parser.add_argument('--dataset', type=str, required=True, help="Dataset name (e.g., ccdv/cnn_dailymail).")
    parser.add_argument('--target_length', type=int, required=True, help="Target word length for articles.")
    parser.add_argument('--num_articles', type=int, required=True, help="Number of articles to retrieve.")
    parser.add_argument('--tolerance', type=float, default=0.05, help="Tolerance range for word count (default is 5%).")
